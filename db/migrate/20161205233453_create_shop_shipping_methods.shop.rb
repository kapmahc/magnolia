# This migration comes from shop (originally 20161121194407)
class CreateShopShippingMethods < ActiveRecord::Migration[5.0]
  def change
    ...
    create_table :shop_shipping_methods_countries, id: false do |t|
      t.references :shop_shipping_method, foreign_key: true, index: {:name => 'idx_shop_shipping_methods_countries_s'}
      t.references :shop_country, foreign_key: true, index: {:name => 'idx_shop_shipping_methods_countries_c'}
    end
